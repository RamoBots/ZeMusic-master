...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/R_surce) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/R_surce) /ZE \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/R_surce)\n [🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝑹𝑨𝑴𝑶 🔱](https://t.me/R_surce)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/R_surce) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/UY_FU"),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/R_surce) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/R_surce) \n ※[These Features AI Based](https://t.me/R_surce)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="R_surce"),
                ],
                [                
                    InlineKeyboardButton(" Commands", callback_data="cbcmds"),
                    InlineKeyboardButton(" Donate", url=f"https://t.me/R_surce"),
                ],
                [
                    InlineKeyboardButton(
                        " DEVELOPER ", url="https://t.me/C_lxl_C"
                    )
                ],
            ]
        ),
...
@Client.on_callback_query(filters.regex("R_surce"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f"""🔱 **※Welcome \n
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع رامو إي من هن : @R_surce **
\n __ Developer """,
        reply_markup=InlineKeyboardMarkup(
